(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".skills__slider")) new swiper_core_Swiper(".skills__slider", {
            ...
            navigation: {
                ...
                prevEl: ".skills__slider-btn--left"
            },
            speed: 1e3,
            mousewheel: true,
            loop: true,
        ...
        if (document.querySelector(".violet-works__slider")) new swiper_core_Swiper(".violet-works__slider", {
    ...
    if (blocks) for (let i = 0; i < blocks.length; i++) {
        function decorVsbl() {
            if (decor[i]) decor[i].classList.add("_visible");
        }
        decor[0].classList.add("_visible");
        blocks[i].addEventListener("click", function() {
            if (blocks[i].classList.contains("_open")) return;
            for (let q = 0; q < blocks.length; q++) {
                blocks[q].classList.remove("_open");
                blocks[i].classList.add("_open");
            }
            for (let q = 0; q < decor.length; q++) {
                decor[q].classList.remove("_visible");
                setTimeout(decorVsbl, 300);
            }
        });
    }
    const startBtn = document.querySelector(".top-block__btn");
    const page = document.querySelector(".page");
    const bg = document.querySelector(".bg");
    const sectionBw = document.querySelector(".section--bw");
    const bw = document.querySelector(".action__block--hi");
    const firstBtn = document.querySelector(".elements__btn--bw");
    document.querySelectorAll(".elements__btn");
    ...
    startBtn.addEventListener("click", function() {
        ...
        setTimeout(showFirstBlock, 1500);
        bg.classList.add("_hide");
        sectionBw.classList.add("visible");
    ...
    for (let i = 0; i < buttons.length; i++) buttons[i].addEventListener("click", function() {
        ...
        if (violetContent.classList.contains("open--1") || violetContent.classList.contains("open--2") || violetContent.classList.contains("open--3") || violetContent.classList.contains("open--4") || violetContent.classList.contains("open--5")) {
            violetContent.classList.remove("open--1", "open--2", "open--3", "open--4", "open--5");
            violetMain.forEach(mainViolet => {
                mainViolet.classList.remove("active");
                mainViolet.style = "display: none;";
            });
        }
        violetBlocks.forEach(violetBlock => {
            violetBlock.classList.remove("_active");
        });
    });
    const violetBlocks = document.querySelectorAll(".violet__item");
    const backBtns = document.querySelectorAll(".violet__btn");
    const violetContent = document.querySelector(".violet__content");
    const violetMain = document.querySelectorAll(".violet__main");
    violetBlocks.forEach(violet => {
        violet.addEventListener("click", function(e) {
            ...
            violetPreview.forEach(preview => {
                preview.classList.remove("preview-on");
                preview.classList.add("preview-off");
                setTimeout(() => {
    ...
    for (let i = 0; i < backBtns.length; i++) backBtns[i].addEventListener("click", function(e) {
        violetContent.classList.remove("open");
        violetPreview.forEach(preview => {
            preview.style = "display: block;";
            preview.classList.remove("preview-off");
            preview.classList.add("preview-on");
    ...
    for (let i = 0; i < violetItem.length; i++) violetItem[i].addEventListener("click", function(e) {
        violetMain.forEach(mainViolet => {
            mainViolet.classList.remove("hidden");
        });
        violetMain[i].classList.add("active");
        setTimeout(() => {
